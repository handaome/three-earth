...
import {EARTH_RADIUS, MAX_CAMERA_DISTANCE, MIN_CAMERA_DISTANCE, TILE_SURFACE_OFFSET,} from "../constants";
...
export class CameraController {
    ...
    private _applyInertia(
        ...
        if (
            Number.isNaN(movement.endX) ||
            Number.isNaN(movement.endY) ||
